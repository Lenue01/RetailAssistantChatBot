...
# Debug: Indicate start of embedding model loading
print("Loading embedding model...")
embedding_model = HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2")
print("Embedding model loaded.")

# Debug: Indicate start of vectorstore loading
...
# NOTE: Replace "ADD ID TOKEN HERE" with your actual Hugging Face token if needed
...
# We'll leave pad_token and eos_token assignments as they are generally good practice
...
# %%
# Define an API endpoint for your RAG system
@app.post("/ask")
async def ask_question(request: QueryRequest):
    ...
    try:
        ...
        # Invoke the chain, which now returns source_documents as well
        ...
        # Debug: Print the final answer generated by the LLM
